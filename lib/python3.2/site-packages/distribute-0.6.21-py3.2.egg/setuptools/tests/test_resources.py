...
import os, pkg_resources, sys, io, tempfile, shutil
try: frozenset
except NameError:
...
class NamespaceTests(TestCase):
    ...
    def test_two_levels_deep(self):
        ...
        for site in ["site-pkgs", "site-pkgs2"]:
            ...
            pkg2_init.close()
        import pkg1
        self.assertTrue("pkg1" in list(pkg_resources._namespace_packages.keys()))
        try:
            import pkg1.pkg2
        except ImportError as e:
            self.fail("Distribute tried to import the parent namespace package")
        # check the _namespace_packages dict
        self.assertTrue("pkg1.pkg2" in list(pkg_resources._namespace_packages.keys()))
